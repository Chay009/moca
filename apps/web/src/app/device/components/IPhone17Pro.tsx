...
Command: npx gltfjsx@6.5.3 public/models/iphone-17-pro/scene.gltf -o src/app/device/components/IPhone17Pro.tsx -t 
...
interface ModelProps extends Omit<JSX.IntrinsicElements['group'], 'ref'> {
  screenTexture?: THREE.Texture | null
}

export function Model({ screenTexture, ...props }: ModelProps) {
  const { nodes, materials } = useGLTF('/models/iphone-17-pro/scene.gltf') as unknown as GLTFResult
  return (
    <group {...props} dispose={null}>
      ...
      {/* Display/Screen mesh - apply custom texture if provided */}
      <mesh geometry={nodes.Object_55.geometry}>
        {screenTexture ? (
...
useGLTF.preload('/models/iphone-17-pro/scene.gltf')
